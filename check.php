...
<body>
	...
	<div class="col-4 ml-auto mr-auto border border-light text-dark mt-5" style="background: white; border-radius: 20px; opacity: 0.7;">
		<h5 style="text-align: center; " class="section-heading mb-4 text-dark mt-2">Вход</h5>
		<form method="POST" action="enter.php" enctype="multipart/form-data">
			...
			<br>
			<br>
			<button class="btn btn-success" style="margin-left: 24%; background: #ABC502">ВОЙТИ</button> 
		</form>
		<br>
